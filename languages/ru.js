module.exports = {
    ...
    start_message: (config) => `Здравствуйте. Версия бота ${config.bot_name} для ВКонтакте наконец-то открылась!\n\nДля доступа к различным функциям нажмите на любую кнопку.`,
    start_buttons: ['Стат-а бота', 'О пользователе', 'О беседе', 'Меню'],
    stats_command: 'Стат-а бота',
    ...
    ocr_command: 'Распознать текст',
    ocr_message: 'Сначала отправьте фотографию.',
    ocr_result: (text) => `🔍 Оптическое распознование символов\nРезультат: ${text}`,
    menu_command: 'Меню',
    menu_message: `📄 Меню`,
    menu_buttons: ['Стат-а бота', 'О пользователе', 'О беседе', 'Магический шар', 'Калькулятор', 'Распознать текст'],
